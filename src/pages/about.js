...
class About extends React.Component {
  render() {
    ...
    return (
      <div>
        <SEO title="Geir Grevling" />
        <h1>
          Geir Grevling kidnapper 7 kaninbabyer, KaninPappa og Peter Kanin og
          EnhjørningLillian tar opp jakten
        </h1>
        <div>
          <p>
            End of Project Gutenberg's The Tale of Mr Tod by Beatrix Potter.
          </p>

          <h1>About this OlaBook</h1>

          <p>
            I practice GatsbyJS by remaking children's books with my daughter
            Lillian (4)
          </p>
        </div>
        ...
        <p>
          <Link to="/1"> or go back to page one </Link>
        </p>

        <p>
          This and all associated files of various formats will be found in:
          <a href="http://www.gutenberg.org/ebooks/19805">
            {" "}
            http://www.gutenberg.org/ebooks/19805
          </a>
        </p>
        <p>
          Produced by Robert Cicconetti, Michael Ciesielski and the PG Online
